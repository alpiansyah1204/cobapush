...
try:
    ...
    def evolve(pop,th,value,kwh):
        ...
        while x >0.4:
            ...
            if x > 0.4:
                ...
                #print(f"\n\nrandomm :{x},change1 : {fn},change2 : {mn},jarak: {ran}")
                if fn != mn:
                    #print(pop[fn],pop[mn])
        ...
        while x >0.4:
            ...
            if x > 0.4 :
                ...
                #print(f"\n\nkromosom : {x}, gen : {y}")
                #print(f"\n\n yang akan di ganti{pop[x][y]}")
                pop[x][y] = Random(value[y],jam[y])
                #print(f"\n\n yang sudah di ganti{pop[x][y]}")
                #print(pop[x])
    ...
    mydb.commit()
#print(mycursor.rowcount, "record inserted.")
    print(sum(mean_fitness)/len(mean_fitness))
