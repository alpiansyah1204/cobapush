<?php
	...
	if(isset($_POST['bsimpan']))
	{
		...
		{
			//Data akan di edit
			$edit = mysqli_query($koneksi, "UPDATE dblatihan set
											 	nim = '$_POST[tnim]',
											 	nama = '$_POST[tnama]',
		...
		else
		{
			...
			$simpan = mysqli_query($koneksi, "INSERT INTO dblatihan (nim, nama, alamat, prodi)
										  VALUES ('$_POST[tnim]', 
										  		 '$_POST[tnama]', 
										  		 '$_POST[talamat]', 
										  		 '$_POST[tprodi]')
	...
	if(isset($_GET['hal']))
	{
		...
		if($_GET['hal'] == "edit")
		{
			...
			$tampil = mysqli_query($koneksi, "SELECT * FROM dblatihan WHERE nim = '$_GET[id]' ");
		...
		else if ($_GET['hal'] == "hapus")
		{
			...
			$hapus = mysqli_query($koneksi, "DELETE FROM dblatihan WHERE nim = '$_GET[id]' ");
			if($hapus){
				echo "<script>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    ...
	    <table class="table table-bordered table-striped">
	    	...
	    	<?php
	    		$no = 1;
	    		$tampil = mysqli_query($koneksi, "SELECT * from dblatihan order by nim desc");
