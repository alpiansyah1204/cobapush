...
<div class="box_hasil">
  <div class="#">
    <a href="python/python.py" style="color:black;width: 100%;">
  ...
  <button type="button" class="close" disabled="" ata-dismiss="alert" aria-label="Close">
    
  </button>
  <strong>Warning! jumlah Device yang di input harus lebih dari 1 dan harus memasukan data pasca bayar </strong> 
</div>
